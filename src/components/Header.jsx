...
function Header() {
  ...
  return (
    <div className="header bg-[#081730] flex max-md:flex-col max-sm:flex-col items-center justify-between px-[10rem] max-md:px-[2rem] max-sm:px-[0rem] pt-[2.4rem]">
        {/* logo */}
        ...
        <CenterMenu/>
        {/* buttons */}
        <div className="buttons max-sm:mt-[-2rem] max-md:mt-[2rem]">
